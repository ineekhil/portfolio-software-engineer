  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className={cn(
          "border-border/50 bg-background/35 text-foreground dark:bg-background/30 pointer-events-none absolute left-1/2 z-[70] max-w-[min(18rem,calc(100dvw-1.5rem))] -translate-x-1/2 rounded-md border px-2 py-1 text-center text-xs font-medium break-words whitespace-normal opacity-0 shadow-sm ring-1 ring-black/5 backdrop-blur-xl transition-opacity duration-200 sm:whitespace-nowrap dark:ring-white/10",
